    ...
    void Update()
    {
        ...
        // ADD isSpawning = true HERE before calling StartNextWave
        // In Update(), change this:
    ...
    {
        // Add small random offset so they don't perfectly stack
        float randomOffset = Random.Range(-0.3f, 0.3f);
        Vector3 spawnPos = new Vector3(spawnPoint.position.x, -3.0f, 0);
    ...
    {
        enemiesAliveInScene--;
        if (enemiesAliveInScene < 0) enemiesAliveInScene = 0; // ADD THIS
    }
